...
> **Status:** Implemented (since v0.8.0) · **Tier:** 2
...
→ Full documentation: [services/birdnet/README.md](https://github.com/kyellsen/silvasonic/blob/main/services/birdnet/README.md)
