...
The `Tier2ServiceSpec` Pydantic model (see [Milestone v0.3.0](../../docs/development/milestone_0_3_0.md) Phase 2) MUST include resource limit fields:
...
*   [Milestone v0.3.0](../../docs/development/milestone_0_3_0.md) — Implementation phases
