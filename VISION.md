...
| ~~uploader~~  | ~~Archived: Upload functionality integrated into Processor as Cloud-Sync-Worker (v0.6.0). See [Refactoring Plan](https://github.com/kyellsen/silvasonic/blob/main/docs/development/refactoring_uploader_to_processor.md)~~ | —                | ❌ Archived    |
