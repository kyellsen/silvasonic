...
| **v0.3.0** | Controller manages Recorder lifecycle (start/stop via `podman-py`, reconciliation loop, Profile Injection)                                                                                                                                                                | 🔨 In Progress |
| v0.4.0     | Recorder writes .wav files (Dual Stream), advanced USB mic configuration                                                                                                                                                                                                         | ⏳ Planned     |
