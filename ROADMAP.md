...
| **v0.5.0** | Analysis & Backend Orchestration — TimescaleDB Hypertable schema, Local Inference (BirdNET & BatDetect models), Postgres LISTEN/NOTIFY bus (ADR-0019)                                                                                                                     | 🔨 In Progress |
